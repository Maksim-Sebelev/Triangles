...
TEST(point_float, testing_default_ctor)
{
    ...
    EXPECT_TRUE(std::isnan(p1.get_x_coordinate()));
    EXPECT_TRUE(std::isnan(p1.get_y_coordinate()));
    EXPECT_TRUE(std::isnan(p1.get_z_coordinate()));
...
TEST(point_float, testing_array_ctor)
{
    ...
    EXPECT_FLOAT_EQ(p1.get_x_coordinate(), 1.0f);
    EXPECT_FLOAT_EQ(p1.get_y_coordinate(), 2.0f);
    EXPECT_FLOAT_EQ(p1.get_z_coordinate(), 3.0f);
...
TEST(point_double, testing_array_ctor)
{
    ...
    EXPECT_FLOAT_EQ(p1.get_x_coordinate(), 1.0);
    EXPECT_FLOAT_EQ(p1.get_y_coordinate(), 2.0);
    EXPECT_FLOAT_EQ(p1.get_z_coordinate(), 3.0);
